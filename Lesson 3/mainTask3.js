...
// const table = document.createElement('table');
//
// let n = prompt('tr number: ');
// let m = prompt('td number: ');
//
// document.body.appendChild(table);
// for (let i = 0; i < n; i++) {
//     const tr = document.createElement('tr');
...
let classElement = document.getElementsByClassName('rules');
...
//         titleDiv.innerText = rules[i].title;
//
//         let bodyDiv = document.createElement('div');
//         div.appendChild(bodyDiv);
//         bodyDiv.innerText = rules[i].body;
//     }
// }
